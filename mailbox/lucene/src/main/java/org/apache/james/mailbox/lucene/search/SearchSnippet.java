...
public class SearchSnippet {
    private String id;
    private String highlightedSubject;
    private String highlightedBody;

    public SearchSnippet(String id, String highlightedSubject, String highlightedBody) {
        this.id = id;
        this.highlightedSubject = highlightedSubject;
